 ...
 */
class FavouriteAdapter(private val viewModel: FavouritesViewModel) :
    ListAdapter<Content, FavouriteAdapter.ContentViewHolder>(TaskDiffCallback()) {
    ...
    class ContentViewHolder private constructor(val binding: ItemContentBinding) :
        ...
        fun bind(viewModel: FavouritesViewModel, content: Content) {
